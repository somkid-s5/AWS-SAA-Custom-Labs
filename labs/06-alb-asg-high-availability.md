# Lab 06: Highly Available Web Tier with ALB + Auto Scaling
...
## Learning Outcomes
- Implement elasticity and self-healing for stateless web workloads.
...
- Tagging standard prepared: `Project=SAA-Lab-06`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-06
