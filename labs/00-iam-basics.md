...
## Learning Outcomes
- Build secure identity boundaries with least privilege, permission boundaries, role assumption, and access analyzer.
...
- Tagging standard prepared: `Project=SAA-Lab-00`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-00
