# Lab 16: CloudFront + S3 OAC Secure Static Delivery
...
## Learning Outcomes
- Serve static content globally while blocking direct bucket access.
...
- Tagging standard prepared: `Project=SAA-Lab-16`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-16
