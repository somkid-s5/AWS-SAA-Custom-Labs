...
## Learning Outcomes
- Centralize secret lifecycle and encryption policy control.
...
- Tagging standard prepared: `Project=SAA-Lab-13`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-13
