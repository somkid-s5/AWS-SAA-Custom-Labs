# Lab 20: Event-Driven Ordering Workflow (Serverless)
...
## Learning Outcomes
- Build resilient async order processing with idempotency and retries.
...
- Tagging standard prepared: `Project=SAA-Lab-20`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-20
