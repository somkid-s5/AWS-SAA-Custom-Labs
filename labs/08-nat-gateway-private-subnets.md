# Lab 08: NAT Gateway Egress Patterns for Private Subnets
...
## Core Services
NAT Gateway, VPC, Route Tables

## Learning Outcomes
- Provide outbound internet for private workloads without exposing inbound ports.
...
- Tagging standard prepared: `Project=SAA-Lab-08`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-08
