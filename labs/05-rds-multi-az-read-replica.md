...
## Core Services
RDS, Route53, CloudWatch

## Learning Outcomes
- Separate HA from read scaling and validate failover characteristics.
...
- Tagging standard prepared: `Project=SAA-Lab-05`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-05
