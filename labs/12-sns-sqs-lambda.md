# Lab 12: SNS + SQS + Lambda Fanout and Retry Control
...
## Learning Outcomes
- Design durable async fanout with replay, throttling, and dead-letter handling.
...
- Tagging standard prepared: `Project=SAA-Lab-12`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-12
