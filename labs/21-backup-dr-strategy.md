# Lab 21: Backup and Disaster Recovery Strategy Validation
...
## Core Services
AWS Backup, RDS Snapshot, S3 CRR

## Learning Outcomes
- Map RTO/RPO requirements to concrete AWS recovery patterns.
...
- Tagging standard prepared: `Project=SAA-Lab-21`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-21
