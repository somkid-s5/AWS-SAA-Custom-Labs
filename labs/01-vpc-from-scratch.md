# Lab 01: Build a Production-Ready VPC from Scratch
...
## Learning Outcomes
- Design a 2-AZ network foundation with public/private subnets and controlled ingress/egress.
...
- Tagging standard prepared: `Project=SAA-Lab-01`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-01
