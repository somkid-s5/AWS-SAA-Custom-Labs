# Lab 03: S3 Security, Encryption, Versioning, and Lifecycle
...
## Core Services
S3, KMS, Lifecycle, IAM

## Learning Outcomes
- Protect object data, reduce cost with tiering, and validate data governance controls.
...
- Tagging standard prepared: `Project=SAA-Lab-03`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-03
