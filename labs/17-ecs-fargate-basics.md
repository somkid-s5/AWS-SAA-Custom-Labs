# Lab 17: ECS Fargate Service Deployment and Rolling Updates
...
## Learning Outcomes
- Run containers serverlessly with health checks, scaling, and deployment safety.
...
- Tagging standard prepared: `Project=SAA-Lab-17`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-17
