# Lab 07: Serverless CRUD API (API Gateway + Lambda + DynamoDB)
...
## Learning Outcomes
- Build an event-safe CRUD API with IAM-scoped access and observability.
...
- Tagging standard prepared: `Project=SAA-Lab-07`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-07
