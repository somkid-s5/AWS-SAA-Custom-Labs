# Lab 15: Governance and Detection with CloudTrail, Config, GuardDuty
...
## Learning Outcomes
- Build baseline detective controls and triage suspicious findings.
...
- Tagging standard prepared: `Project=SAA-Lab-15`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-15
