# Lab 18: ElastiCache Session Offload and Latency Reduction
...
## Core Services
ElastiCache Redis, EC2/ECS

## Learning Outcomes
- Move hot session/state reads from database to in-memory cache.
...
- Tagging standard prepared: `Project=SAA-Lab-18`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-18
