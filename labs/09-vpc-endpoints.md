# Lab 09: VPC Endpoints (Gateway + Interface) and Private Access
...
## Core Services
S3 Endpoint, Interface Endpoint, Private DNS

## Learning Outcomes
- Eliminate internet-path dependency when accessing AWS APIs and S3.
...
- Tagging standard prepared: `Project=SAA-Lab-09`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-09
