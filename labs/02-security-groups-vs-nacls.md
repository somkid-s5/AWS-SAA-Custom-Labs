# Lab 02: Security Groups vs NACLs (Deep Comparison)
...
## Core Services
EC2, SG, NACL, VPC Flow Logs

## Learning Outcomes
- Understand stateful vs stateless filtering through repeatable traffic tests.
...
- Tagging standard prepared: `Project=SAA-Lab-02`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-02
