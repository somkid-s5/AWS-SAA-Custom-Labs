# Lab 24: Multi-Account Landing Zone Thinking
...
## Learning Outcomes
- Design guardrails, account boundaries, and centralized governance.
...
- Tagging standard prepared: `Project=SAA-Lab-24`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-24
