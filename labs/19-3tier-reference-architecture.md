...
## Learning Outcomes
- Assemble end-to-end web architecture with separation of concerns.
...
- Tagging standard prepared: `Project=SAA-Lab-19`, `Owner=<your-name>`, `TTL=<date>`.
...
aws resourcegroupstaggingapi get-resources --tag-filters Key=Project,Values=SAA-Lab-19
